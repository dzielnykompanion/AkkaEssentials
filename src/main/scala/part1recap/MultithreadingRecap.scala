...
object MultithreadingRecap extends App {
  ...
  val aThread0 = new Thread(new Runnable {
    override def run(): Unit = println("I'm running paraller")
  })
  val aThread = new Thread(() => println("I'm running in paraller"))
  ...
  future.onComplete {
    ...
    case Failure(_) => println("Something with the meaning of life!")
  }
